(function () {
    ...
    if (localStorage.vertixrtl) {
        ...
        document.querySelector("#style")?.setAttribute("href", "https://laravelui.spruko.com/vertix/build/assets/libs/bootstrap/css/bootstrap.rtl.min.css");
            // rtlFn();
    }
...
function ltrFn() {
    ...
    if(!document.querySelector("#style").href.includes('bootstrap.min.css')){
        document.querySelector("#style")?.setAttribute("href", "https://laravelui.spruko.com/vertix/build/assets/libs/bootstrap/css/bootstrap.min.css");
    }
