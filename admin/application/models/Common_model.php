...
class Common_model extends CI_Model {
    ...
    public function GetDatas( $table, $select, $where = NULL, $orderby = NULL, $groupby = NULL ) {
    ...
    public function isTimeSlotBooked( $court, $date, $timeSlots )
    {
        ...
        $this->db->where(['fld_aserv' => $court, 'fld_adate' => $date, "JSON_CONTAINS(fld_atime)" => $timeSlotsJson]);
