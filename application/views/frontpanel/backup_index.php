                ...
                <div class="row">
                    <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-8">
                        <div class="py-lg-5">
                            ...
                            <div class="fs-16 mb-5 text-fixed-white op-7" id="sub-text">Join the action at Winkin and experience the thrill of every match!</div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-0">
                            <form class="wizard wizard-tab horizontal" method="POST" id="cust_appointment_form">
                                ...
                                <aside class="wizard-content container">
                                    ...
                                    <div class="wizard-step active" data-title="Court(s)" data-id="2e8WqSV3slGIpTbnjcJzmDwBQaHrfh0Z">
                                        <div class="row gy-4">
                                            <div class="col-xl-6">
                                                <div class="col">
                                                    <div class="form-check d-flex align-items-center">
                                                        <div class="flex-fill align-items-center">
                                                            <label for="courtA">
                                                                <img src="<?= base_url('assets/images/court.png'); ?>" width="80%" class="m-5 mobileView" alt="courtA" style="border-radius: 5%;">
                                                            </label>
                                                            <div class="d-flex justify-content-center input-group">
                                                                <label for="courtA" class="text-center mt-2"> <b>Court A</b> </label> &nbsp;
                                                                <input name="court" class="fs-5 border-dark form-check-input form-checked-primary rounded-circle" type="radio" value="courtA" data-duration="60" data-rate="500" id="courtA" <?= ( (!empty($appservs) && ($appservs == 'courtA') ) ? 'checked' : ''); ?> >
                                                                <input type="hidden" name="court_dura[courtA]" value="60" >
                                                                <input type="hidden" name="court_rate[courtA]" value="500" >
                                                            </div>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="col">
                                                    <div class="form-check d-flex align-items-center gap-3 p-2">
                                                        <div class="flex-fill">
                                                            <label for="courtB">
                                                                <img src="<?= base_url('assets/images/court.png'); ?>" width="80%" class="m-5 mobileView" alt="courtB" style="border-radius: 5%;">
                                                            </label>
                                                            <div class="d-flex justify-content-center input-group">
                                                                <label for="courtB" class="text-center mt-2"> <b>Court B</b> </label> &nbsp;
                                                                <input name="court" class="fs-5 border-dark form-check-input form-checked-primary rounded-circle" type="radio" value="courtB" data-duration="60" data-rate="500" id="courtB" <?= ( (!empty($appservs) && ($appservs == 'courtB') ) ? 'checked' : ''); ?> >
                                                                <input type="hidden" name="court_dura[courtB]" value="60" >
                                                                <input type="hidden" name="court_rate[courtB]" value="500" >
                                                            </div>
                                    ...
                                    <div class="choose-serv-error-msg text-danger text-center mt-4"></div>

                                    <div class="wizard-step" data-title="Select Date & Time" data-id="dOM0iRAyJXsLTr9b3KZfQ2jNv4pgn6Gu" data-limit="3">
                                        <div class="row" id="staffCalender">

                                            <div class="cal-menu-wrapper">
                                                <ul class="cal-menu">
                                                    <?php
                                                        ...
                                                        for ($d = 0; $d < $days; $d++) {
                                                            ...
                                                            $calDate = date('d', $strtotime);
                                                            $calDay = date('D', $strtotime);
                                                            $leaveDate = date('Y-m-d', $strtotime);
                                                    ?>
                                                    <li class="cal-item <?= ( (!empty($app_date) && ($app_date == date('Y-m-d', $strtotime)) || (empty($app_date) && $startDate == date('Y-m-d', $strtotime))) ) ? 'calactive' : ''; ?> <?= ( (!in_array($calDay, $weeks) || in_array($leaveDate, array_keys($leave_data)) ) ? 'cal-disabled' : 'cal-date'); ?> <?= (in_array($leaveDate, array_keys($leave_data)) ? 'cal-leave' : ''); ?>" data-date="<?= date('Y-m-d', $strtotime); ?>" title="<?= (in_array($leaveDate, array_keys($leave_data)) ? $leave_data[$leaveDate] : ''); ?>" >

                                                        <h4 class="text-center mb-2 mt-3"><?= $calDate; ?></h4>
                                                        <span class="fw-semibold d-block text-center mb-2"><?= date('M', $strtotime); ?></span>
                                                        <span class="fw-semibold d-block fw-medium text-center lh-1"><?= $calDay; ?></span>
                                                    </li>
                                                    <?php } ?> 
                                                </ul>
                                                <div class="cal-paddles">
                                                    <button type="button" class="cal-left-paddle cal-paddle hidden"> <i class="bi bi-caret-left-fill"></i> </button>
                                                    <button type="button" class="cal-right-paddle cal-paddle"> <i class="bi bi-caret-right-fill"></i> </button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="text-center"><span class="choose-time-error-msg text-danger"></span></div>
                                        </div>
                                    </div>

                                    <?php if(empty($appkey)) { ?>
                                        <div class=" wizard-step " data-title="Personal Information" data-id="2e8WqSV3slGIpTbnjcJzmDwBQaHrfh0Z">
                                            <div class="text-center">
                                                <p class="sign-btn mt-3 mb-0">Already have an account? 
                                                    <a id="sign-btn" data-title="sign-in" class="btn btn-primary">Sign In</a>
                                                </p>
                                            </div>
                                            <div class="row gy-3 sign-up-tab mt-2">
                                                ...
                                                <div class="col-xl-6 mt-3">
                                                    ...
                                                    <input type="text" name="cust_name" class="form-control" id="cust_name" value="" />
                                                ...
                                                <div class="col-xl-6 mt-3">
                                                    ...
                                                    <input type="text" name="cust_lname" class="form-control" id="cust_lname" value="" />
                                                    <span class="appoint-error-msg text-danger"></span>
                                                </div>
                                                ...
                                                <div class="col-xl-6 mt-3">
                                                    ...
                                                    <div class="input-group mt-2">
                                                        <div class="col-3">
                                                            <select name="countrycode" class="form-control col-4" id="countrycode">
                                                                <?php 
                                                                    foreach ($countrycodes as $country => $code) {
                                                                   echo "<option value='".$code['fld_id'];
                                                                   if($code['fld_countryname'] == "India") { 
                                                                        echo "' selected >"; 
                                                                    } else { 
                                                                        echo "'>";
                                                                    }
                                                ...
                                                <div class="col-xl-7">
                                                    <div class="login-page">
                                                        ...
                                                        <div class="row justify-content-center gy-4">
                                                            <div class="col-xl-8">
                                                                <label for="signin_phone" class="form-label">Phone Number</label>
                                    ...
                                    <div class="wizard-step" data-title="Confirmation" data-id="dOM0iRAyJXsLTr9b3KZfQ2jNv4pgn6Gu" data-limit="3">
                                        <div class="row">
                                            <div class="mb-4">
                                                <h5 class="text-success fw-medium">Booking Confirmation.</h5>
                                            </div>

                                            <div class="col-xl-6">

                                                <!-- <div class="btn-group mb-3 d-sm-flex d-block mt-4" role="group" aria-label="Basic radio toggle button group">
                                                    <input type="radio" class="btn-check" name="paymethode" id="COV" value="COV" checked>
                                                    <label class="btn btn-outline-light text-default mt-sm-0 mt-1" for="COV">C.O.V(Cash on Visit)</label>
                                                    <input type="radio" class="btn-check upi_method" onchange="handlePaymentMethodChange()" name="paymethode" id="UPI" value="UPI">
                                                    <label class="btn btn-outline-light text-default mt-sm-0 mt-1" for="UPI">UPI</label>
                                                </div> -->
                                                ...
                                                <div class="card-footer">
                                                    <div class="row gy-3">
                                                        ...
                                                        <label for="snotes"> <b>Service Notes:</b></label>
                                                        <textarea class="form-control" rows="4" name="serv_notes" id="snotes" placeholder="text here..."></textarea>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="mb-4 text-center">
                                            <p class="mb-1 fs-14">You will get the appointment details to your email address</p>
                                            <button type="submit" class="btn btn-success mt-4">Book Appointment</button>
                                        </div>
                                    </div>
                                </aside>
                            </form>
...
$(document).ready(function() {
   ...
   $('.owl-carousel').owlCarousel({
    ...
    $('body').on('click', '#sign-btn', function() {
        ...
        if(title == "sign-in") {
            $('.sign-btn').html('Don&apos;t have an account? <a id="sign-btn" data-title="sign-up" class="btn btn-primary"> SIGN UP </a> ');
            $('.sign-up-tab').addClass('d-none');
            $('.sign-in-tab').removeClass('d-none');
        } else {
            $('.sign-btn').html('Already have an account? <a id="sign-btn" data-title="sign-in" class="btn  btn-primary"> SIGN IN </a> ');
    ...
    $('body').on('click', "input[name='times[]']", function() {
        ...
        var element = $("input[name='times[]']").parent().parent();
        var checkedElement = $("input[name='times[]']:checked").parent().parent();
        element.removeClass('btn-success text-white').addClass('btn-outline-success');
        checkedElement.removeClass('btn-outline-success').addClass('btn-success text-white');
        ...
        for(var c = 0; c < courttimings.length; c++) {
            tbody += "<tr class='text-center'> <td>"+selCourt+"</td> <td>"+courttimings[c]+"</td> <td>"+CourtRate+"</td> </tr>";
            courttotal += parseFloat(CourtRate);
        }

        var gstAmount = courttotal * 0.2;

        var storeGstAmount = courttotal * 0.18;
        var paymentAmount = courttotal * 0.02;
        var grandTotal = courttotal + gstAmount;

        tfoot += "<tr class='showCoupon d-none'><td colspan='2' align='right'> <b>Coupon Percent % :</b> </td> <td align='center' id='coupon_Percent'></td></tr> <tr class='showCoupon d-none'><td colspan='2' align='right'> <b>Coupon Amount :</b> </td> <td align='center' id='coupon_Amount'></td></tr> <tr><td colspan='2' align='right'> <b>Subtotal :</b> </td> <td align='center' id='sub_Amount'>"+courttotal+"</td> <input type='hidden' id='cpid' name='fld_acpid' /> <input type='hidden' name='fld_acppercent' id='cperc' /> <input type='hidden' name='fld_acpamt' id='cpamt' /> <input type='hidden' name='old_amount' id='old_amount' value="+grandTotal+" /> <input type='hidden' name='gst_amount' id='gst_amount' value="+storeGstAmount+" /><input type='hidden' name='payment_amount' id='payment_amount' value="+paymentAmount+" /> </tr><tr><td colspan='2' align='right'> <b>Total :</b> <br> <small>(Including GST)</small> </td> <td align='center' id='total_Amount'>"+grandTotal+"</td></tr>";
    ...
    $('body').on('change', "input[type=radio][name='court']", function() {
        ...
        var appdate = $('.calactive').data('date');
        var courts = $(this).val();
        ...
        $.ajax({
            ...
            success : function (res) {
                ...
                if(res.status == 200) {
                    ...
                    AlertPopup('Failed!', 'Appointment Not Booked Successfully!', 'error', 'Try Again', 'mybookings');
                }
            }, 
