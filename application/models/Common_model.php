...
class Common_model extends CI_Model {
    ...
    public function get_max( $table_name = '', $field_name, $where = array() ) {
        $this->db->select_max( $field_name );
        $query = $this->db->get_where( $table_name, $where );
        return $query->result_array();
    }

    public function get_where( $table_name = '', $where = array(), $data = '*' ) {
    ...
    public function get_where_in( $table_name = '', $field_name, $where = array() ) {
        $this->db->where_in( $field_name, $where );
        $query = $this->db->get( $table_name );
        return $query->result_array();
    }

    public function get_in( $table_name = '', $where = array(), $field_name = '', $select_field_name = '', $where_data = array() ) {
    ...
    public function get_count( $table_name = '', $where = array(), $distinct_value = NULL ) {
    ...
    public function getWhereJoin( $select, $table1, $where1, $table2 = '', $where2 = '', $order = '', $table3 = '', $where3 = '' ) {
    ...
    public function get_count_like( $table_name = '', $where = array() ) {
        $this->db->like( $where );
    ...
    public function get_select_records( $table_name = '', $field_name = '', $where = array() ) {
    ...
    public function get_records( $table_name = '', $where = array(), $limit = null, $offset = null, $order_by_field = null, $order_by_order = null ) {
    ...
    public function get_where_row( $table_name = '', $where = array(), $data = '*' ) {
        $this->db->select( $data );
        $rs = $this->db->get_where( $table_name, $where );
        return $rs->row();
    }
    ...
    public function get_like( $table_name = '', $where = array(), $limit = null, $offset = null, $order_by_field = null, $order_by_order = null ) {
    ...
    public function get_list( $id_field_name, $value_field_name, $table_name, $where = array(), $init_list = array(), $order_by_field = null, $order_by_order = null, $concatname = null ) {
    ...
    // get one field
    public function get_one( $field_name, $table_name, $where = array() ) {
        $records = $this->get_records( $table_name, $where );
        if ( $records != false ) {
    ...
    public function update_or_insert( $table_name = '', $data = array(), $where = array() ) {
    ...
    public function GetDatas( $table, $select, $where = NULL, $orderby = NULL ) {
